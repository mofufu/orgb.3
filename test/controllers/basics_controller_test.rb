...
class BasicsControllerTest < ActionController::TestCase
  ...
  test "should create basic" do
    assert_difference('Basic.count') do
      post :create, basic: { marketing_plan_id: @basic.marketing_plan_id, objective: @basic.objective, plan_description: @basic.plan_description, value_proposition: @basic.value_proposition }
    end
  ...
  test "should update basic" do
    patch :update, id: @basic, basic: { marketing_plan_id: @basic.marketing_plan_id, objective: @basic.objective, plan_description: @basic.plan_description, value_proposition: @basic.value_proposition }
    assert_redirected_to basic_path(assigns(:basic))
  end
