class StrategiesController < ApplicationController
  ...
  private
    ...
    def strategy_params
      params.require(:strategy).permit(:marketing_plan_id, :type_of_activity, :start_date, :end_date, :implementation_team, :estimated_cost, :media_strategy, :distribution_channels)
    end
end
